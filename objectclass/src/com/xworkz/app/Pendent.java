...
public class Pendent {
	...
	public String toString() {
		...
		return "Brand :" + brand + "Pure Gold :" + pureGold + "Clasp Type :" + claspType + "Metal Type :" + metalType
				+ "Gem Type :" + gemType + "Stone :" + stone + "Metal Stamp :" + metalStamp + "Warranty :" + warranty
				+ "Lustree :" + lustree + "Price :" + price + "Seller :" + seller;
	}
}
